...
export default function AdminProjects() {
  ...
  const fetchProjects = async () => {
    try {
      const res = await api.get("/admin/projects/getAll.php");
  ...
  const handleSave = async () => {
    ...
    try {
      if (editing) {
        await api.post("/admin/projects/update.php", {
          id: editing.id,
          title,
          description,
          link,
        ...
        await api.post("/admin/projects/create.php", { title, description, link });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await api.post("/admin/projects/delete.php", { id });
    ...
    <div className="p-6">
      ...
      <Dialog isOpen={open} onClose={() => setOpen(false)}>
        <div className="space-y-3">
          ...
          <input
            type="text"
            placeholder="Optional link (GitHub, website, etc.)"
            className="border rounded-lg w-full p-2"
            value={link}
