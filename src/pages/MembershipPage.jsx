...
const MembershipPage = () => {
  return (
    <SEOWrapper
      title="Membership | NITP Oyo State Chapter"
      description="Join the Nigerian Institute of Town Planners (NITP) Oyo State Chapter and advance your career in sustainable urban development."
      image="/assets/membership-hero.jpg"
