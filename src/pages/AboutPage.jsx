...
export default function AboutPage() {
  return (
    <SEOWrapper
      title="About NITP Oyo State Chapter | Nigerian Institute of Town Planners"
      description="Learn about the history, mission, vision, and leadership of the NITP Oyo State Chapter, advancing sustainable urban planning in Oyo State."
